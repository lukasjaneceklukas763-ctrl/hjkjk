(() => {
  ...
  const SWF_FILE = "Madness Project Nexus Classic TRUE ONLINE COOP COMPLETE SYNC.swf?v=20260622-complete-sync-v12";
  ...
  async function installNetworkShim() {
    ...
    try {
      await navigator.serviceWorker.register("./sw.js?v=20260622-complete-sync-v12", { scope: "./" });
